...
var nextTask = function () {
  var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(type, key, map) {
    var scheduled;
...
var renderThread = function () {
  var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(boardName, threadNumber, postNumber, action) {
    var isDeleted;
...
var scheduleRender = exports.scheduleRender = function () {
  var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee11(data) {
    var _this = this;
