...
var DEFAULT_VALUES = new Map([['board.useDefaultBoards', true], ['server.ddosProtection.enabled', true], ['server.ddosProtection.ws.connectionLimit', 10], ['server.ddosProtection.ws.maxMessageLength', 20480], ['server.ddosProtection.ws.maxMessageRate', 6], ['server.rss.enabled', true], ['server.rss.postCount', 500], ['server.rss.ttl', 60], ['server.statistics.enabled', true], ['server.statistics.ttl', 60], ['site.protocol', 'http'], ['site.domain', 'localhost:8080'], ['site.pathPrefix', ''], ['site.locale', 'en'], ['site.dateFormat', 'MM/DD/YYYY hh:mm:ss'], ['site.timeOffset', 0], ['site.vkontakte.accessToken', ''], ['site.vkontakte.appId', ''], ['site.vkontakte.integrationEnabled', false], ['site.twitter.integrationEnabled', true], ['site.ws.transports', ''], ['site.maxSearchQueryLength', 50], ['system.detectRealIp', true], ['system.elasticsearch.host', 'localhost:9200'], ['system.useXRealIp', false], ['system.log.backups', 100], ['system.log.maxSize', 1048576], ['system.log.targets', ['console', 'file']], ['system.mimeTypeRetrievingTimeout', 5 * 1000], ['system.phash.enabled', true], ['system.redis.host', '127.0.0.1'], ['system.redis.port', 6379], ['system.redis.family', 4], ['system.redis.password', ''], ['system.redis.db', 0], ['system.redis.enableReadyCheck', false], ['system.redis.maxRedirections', 16], ['system.redis.scaleReads', 'master'], ['system.redis.retryDelayOnFailover', 100], ['system.redis.retryDelayOnClusterDown', 100], ['system.redis.retryDelayOnTryAgain', 100], ['system.rerenderCacheOnStartup', true], ['system.rerenderArchive', false], ['system.searchLimit', 100], ['system.workerCount', _os2.default.cpus().length]]);
