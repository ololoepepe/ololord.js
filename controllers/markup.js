...
router.generateHTML = function () {
    ...
    model.markedUpCode = "<div class=\"code-block cpp hljs\" title=\"C++\">" + Highlight.fixMarkup(result.value) + "</div>";
    ...
    if (config("site.twitter.integrationEnabled", true)) model.extraScripts = [{ fileName: "3rdparty/twitter.js" }];
